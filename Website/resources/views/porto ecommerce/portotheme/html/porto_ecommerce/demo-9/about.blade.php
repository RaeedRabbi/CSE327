...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo-9/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2019 08:08:23 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <main class="main">
            ...
            <div class="history-section">
                ...
                <div class="history-row">
                    <div class="history-row-bg" style="background-image: url('assets/images/half-bg.jpg');"></div><!-- End .history-row-bg -->
                    <div class="container">
                        <div class="row">
            ...
            <div class="team-section">
                <div class="container">
                    ...
                    <div class="team-carousel owl-carousel owl-theme">
                        ...
                        <div class="member">
                            <img src="assets/images/team/member-2.jpg" alt="member name">
                            <h3 class="member-title">John DOE</h3>
                            <div class="member-job">Marketing</div>
                        </div><!-- End .member -->

                        <div class="member">
                            <img src="assets/images/team/member-3.jpg" alt="member name">
                            <h3 class="member-title">George DOE</h3>
                            <div class="member-job">Designer</div>
                        </div><!-- End .member -->

                        <div class="member">
                            <img src="assets/images/team/member-4.jpg" alt="member name">
                            <h3 class="member-title">JANE DOE</h3>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo-9/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2019 08:08:25 GMT -->
</html>